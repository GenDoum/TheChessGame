...
public class TestData
{
    ...
    public static IEnumerable<object[]> InvalidUserPseudo()
    {
        ...
        yield return new object[] {"", "password", ChessLibrary.Color.White, true, 0}; // Empty pseudo with Color.White
        yield return new object[] {"", "password", ChessLibrary.Color.White, false, 0}; // Empty pseudo with Color.White

        yield return new object[] {"", "password", ChessLibrary.Color.Black, true, 0}; // Empty pseudo with Color.Black
        yield return new object[] {"", "password", ChessLibrary.Color.Black, false, 0}; // Empty pseudo with Color.Black

        yield return new object[] {" ", "password", ChessLibrary.Color.White, true, 0}; // Pseudo with white space and Color.White
        yield return new object[] {" ", "password", ChessLibrary.Color.White , false, 0}; // Pseudo with white space and Color.White
    ...
    {
        yield return new object[] {"pseudo", "password", ChessLibrary.Color.White, true, 0}; // Good password with Color.White
        yield return new object[] {"pseudo", "password", ChessLibrary.Color.White, false, 0}; // Good password with Color.White
    ...
    {
        yield return new object[] {"pseudo", "", ChessLibrary.Color.White, true, 0}; // Empty password qui Color.White
        yield return new object[] {"pseudo", "", ChessLibrary.Color.White, false, 0}; // Empty password qui Color.White

        yield return new object[] {"pseudo", "", ChessLibrary.Color.Black, true, 0}; // Empty password qui Color.Black
        yield return new object[] {"pseudo", "", ChessLibrary.Color.Black, false, 0}; // Empty password qui Color.Black
    }

    public static IEnumerable<object[]> ValidUserColor()
    {
        yield return new object[] {"pseudo", "password", ChessLibrary.Color.White, true, 0}; // Good User with Color.White
        yield return new object[] {"pseudo", "password", ChessLibrary.Color.White, false, 0}; // Good User with Color.White
    ...
    {
        yield return new object[] {"pseudo", "password", ChessLibrary.Color.White, true, 0};
        yield return new object[] {"pseudo", "password", ChessLibrary.Color.White, true, 0};

        yield return new object[] { "pseudo", "password", ChessLibrary.Color.White, false, 1};
        yield return new object[] { "pseudo", "password", ChessLibrary.Color.White, false, 1};

        yield return new object[] { "pseudo", "password", ChessLibrary.Color.Black, true, 0};
        yield return new object[] { "pseudo", "password", ChessLibrary.Color.Black, true, 0};

        yield return new object[] { "pseudo", "password", ChessLibrary.Color.Black, false, 1};
        yield return new object[] { "pseudo", "password", ChessLibrary.Color.Black, false, 1};
    }
    ...
    public static IEnumerable<object[]> InvalidUserScore()
    {
        ...
        yield return new object[] { "pseudo", "password", ChessLibrary.Color.White, false, ""};
        yield return new object[] { "pseudo", "password", ChessLibrary.Color.White, false, ""};

        yield return new object[] { "pseudo", "password", ChessLibrary.Color.Black, true, ""};
        yield return new object[] { "pseudo", "password", ChessLibrary.Color.Black, true, ""};
    ...
    {
        var chessboard = new Chessboard(new Case[8, 8], true); // Initialisation d'un �chiquier vide pour les tests contr�l�s

        // Ajout d'un fou blanc en position (2,0) et v�rification d'un mouvement diagonal valide
        ...
        // Ajout d'une tour noire en position (5,7) et v�rification d'un mouvement vertical valide
        ...
        // Ajout d'un cavalier blanc et v�rification d'un mouvement en "L" valide
    ...
    public static IEnumerable<object[]> InvalidIsMoveValidData()
    {
        ...
        // Cavalier essayant de se d�placer hors du plateau
