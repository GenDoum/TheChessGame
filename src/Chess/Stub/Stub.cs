...
namespace Stub
{
    public class Stub : IPersistanceManager
    {
        public (ObservableCollection<Game>, ObservableCollection<User>, ObservableCollection<Chessboard>) LoadData()
        {
            ...
            User user3 = new User("Acc", "mdp", ChessLibrary.Color.White, false, 10);
            User user4 = new User("Mouyon", "mdp", ChessLibrary.Color.White, false, 3000);
            User user5 = new User("Balko", "mdp", ChessLibrary.Color.White, false, 5000);
            User user6 = new User("Lascret", "mdp", ChessLibrary.Color.White, false, 6000);
